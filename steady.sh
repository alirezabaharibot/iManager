...
RELOADTIME=20  # Time between checking cpu calls of the cli process. Set the value high if your bot does not receive lots of messages.
...
echo -e "\e[1m"
echo -e ""
echo "روبات در صفحه درحال اجرا است"
echo ""
echo -e "\e[0m"
sleep 3
quit
